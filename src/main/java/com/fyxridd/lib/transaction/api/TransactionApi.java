...
public class TransactionApi {
    ...
    /**
     * @see #newTipTransaction(boolean, String, long, int, String, List, HashMap, HashMap, String, boolean)
     */
    ...
    /**
     * @see #tip(boolean, String, String, List, HashMap, HashMap, String, boolean)
     */
